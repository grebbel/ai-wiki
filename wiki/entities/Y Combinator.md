...
### 4. Garg / YC Root Access ([[2026-05-19-garg-yc-internal-ai-agent-evolves-itself|Garg 2026]])
...
### 5. Glasgow / YC Root Access ([[2026-05-20-glasgow-campfire-erp-for-ai-revolution|Glasgow 2026]])
...
### 6. Tan & Hu / Stanford CS153 ([[2026-05-20-tan-hu-stanford-cs153-ai-native-company-1000x-engineer|Tan & Hu 2026]])
...
### 7. Akhtar & Forget / Letter AI ([[2026-02-25-akhtar-forget-yc-letter-ai-powered-revenue|Akhtar & Forget 2026]])
...
### 8. Wu & An / Momentic ([[2026-03-23-wu-an-yc-momentic-qa-layer-ai-coding-era|Wu & An 2026]])

[[Momentic]] co-founders **Weiwei Wu** and **Jeff An** (YC W24) in conversation with [[Harj Taggar]] on YC Root Access *Founder Firesides* (published 23 March 2026). $15M Series A announcement. The **verification-layer-for-software / truth-driven-development** anchor — Momentic does functional testing (impersonates end users) and integrates with Cursor and Claude Code via MCP as the *closing-the-loop-for-coding-agents* product surface. Notion runs ~500K test runs/day on Momentic with *"Momentic tests must pass before one of Notion's engineers can merge their PR."* **Productive contradiction filed** with the [[2026-05-20-tan-hu-stanford-cs153-ai-native-company-1000x-engineer|Tan & Hu CS153 1,000×-engineer]] thesis: Wu's *"Codex only makes you a 10x engineer if you weren't a 10x engineer to begin with"* is a direct rhetorical inversion — the multiplier as conditional on existing skill rather than unconditional.

### 9. Dinakaran / Luminai ([[2026-04-09-dinakaran-yc-luminai-automating-americas-biggest-hospitals|Dinakaran 2026]])
...
- **Garry Tan** — President & CEO since 2023; engineer (Stanford CS); ex-Palantir #10; Posterous co-founder; built first version of Bookface. **The AI founder type archetype operationalised** at YC-president scale — runs 10-15 parallel Claude Code sessions, ~400 PRs in review. **Second-source mention**: referenced by name in [[2026-05-19-garg-yc-internal-ai-agent-evolves-itself|Garg 2026]] (*"as Pete and Tom and Gary mentioned"*) as a prior speaker in the same YC Root Access multi-talk session. Promote when a second standalone-source mention lands.
...
- **Pete Koomen** — likely YC partner; referenced in [[2026-05-19-garg-yc-internal-ai-agent-evolves-itself|Garg 2026]] as a prior speaker in the same YC Root Access session covering the *thin harness* point. Currently Dangling; promote when his slot in the session is ingested or a second standalone source surfaces.
...
- **Ayush Garg** — founder of AnswerThis; speaker on YC Root Access ([[2026-05-19-garg-yc-internal-ai-agent-evolves-itself|Garg 2026]]). Currently Dangling; promote on second-source mention.
...
- **Mukund Jha** — founder/CEO of Emergent; second YC-portfolio founder vantage on Claude Code as substrate ([[2026-05-13-jha-emergent-democratizing-app-building-with-claude|Jha 2026]]). Currently Dangling; promote on second-source mention.
- **Kesava Kirupa Dinakaran** — founder/CEO of [[Luminai]] (YC S20); the *paper-and-fax-vertical-AI-wedge* anchor for healthcare-administrative automation ([[2026-04-09-dinakaran-yc-luminai-automating-americas-biggest-hospitals|Dinakaran 2026]]). Childhood Rubik's-cube champion who learned the cube from [[Andrej Karpathy]]'s YouTube tutorials. Currently Dangling; promote on second-source mention.
- **Ali Akhtar** — co-founder/CEO of [[Letter AI]] (originally *Tractatus*, ~W23/S23 batch); the *MCP-server-as-vendor-product-surface* anchor for sales enablement ([[2026-02-25-akhtar-forget-yc-letter-ai-powered-revenue|Akhtar & Forget 2026]]). Ex-Director of Engineering for ML at Samsara and project44. Currently Dangling; promote on second-source mention.
- **Armen Forget** — co-founder/CTO of [[Letter AI]]; same ingest. Currently Dangling; promote on second-source mention.
- **Weiwei Wu** — co-founder of [[Momentic]] (YC W24); the *truth-driven-development / closing-the-loop-for-coding-agents* anchor for the QA vertical ([[2026-03-23-wu-an-yc-momentic-qa-layer-ai-coding-era|Wu & An 2026]]). Ex-Robinhood (testing-team experience anchor; saw team grow 300 → 1,000 engineers). Currently Dangling; promote on second-source mention.
