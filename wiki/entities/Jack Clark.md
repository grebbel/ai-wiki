...
relationships:
  - type: part-of
    target: Anthropic
    via: "Co-founder; Head of Public Benefit (current); previously Head of Policy"
  - type: part-of
    target: AI-Index
    via: "Founding member 2017–2024; Steering Committee on the 2026 edition (representing Anthropic / OECD)"
---
...
- **Founding member of the [[AI Index]]** at [[Stanford HAI]] (2017–2024); continues on the Steering Committee for the [[2026-04-30-ai-index-report-2026|2026 edition]] (representing Anthropic / OECD per the AI Index page's member list).
...
LIST
FROM "wiki/sources"
WHERE contains(file.outlinks, this.file.link) OR contains(tags, "clark")
SORT file.name ASC
```
