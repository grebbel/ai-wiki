...
- **Tension with [[2022-06-29-martin-hbr-a-plan-is-not-a-strategy|Martin 2022]]'s Southwest example.** Martin treats Southwest's win as a finite-game beat (Southwest *won* by serving a segment incumbents missed; share moves; *"a smaller pie left over after Southwest takes whatever share it wants"*). Sinek would say Southwest's *durable* outperformance — not the single-decade growth — is an infinite-game property (improving the institution year-over-year). The two framings are compatible but they emphasise different time horizons; flag as a productive tension the wiki should hold rather than resolve.
