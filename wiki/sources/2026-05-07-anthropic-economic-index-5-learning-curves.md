...
**Entities (this wiki):** [[Anthropic Economic Index]] (this is the 5th report; bumps `source_count`), [[Anthropic]] (publisher; bumps `source_count`), [[Jack Clark]] (named in the acknowledgements — promoted on cross-page presence: the [[Anthropic]] page lists him as co-founder and the [[AI Index]] page lists him as a Steering Committee member). **Promoted to entities** (second-source rule — also lead-author the [[2026-03-05-massenkoff-mccrory-anthropic-labor-market-impacts-ai|March 2026 labor-impacts report]]): [[Maxim Massenkoff]], [[Peter McCrory]]. **Dangling** (single-source, deferred): Eva Lyubich (lead author), Ruth Appel, Ryan Heller (authors).
